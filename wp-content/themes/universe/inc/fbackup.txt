		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/universe/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://registrar.name/' target='_blank'>Domain Registrar</a>, thanks to: <a href='http://vacationhomerental.info/' target='_blank'>Vacation Home Rentals</a>, <a href='http://theme.today/' target='_blank'>http://theme.today</a> and <a href='http://forwp.com/' target='_blank'>www.forwp.com</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
	</div> <?php //footer ?>
